...
class GeneralizedRCNN(nn.Module):
    ...
    def generate_soften_proposal(self, images, targets=None):
        ...
        (proposals, proposal_losses), anchors, rpn_output = self.rpn(images, features,
        ...
        soften_scores, soften_bboxes = self.roi_heads.calculate_soften_label(features, selected_proposals,
                                                                             targets)  # use ROI-subnet to generate final results

        return (soften_scores,
                soften_bboxes), selected_proposals, features, backbone_features, anchors, rpn_output, feature_proposals
    ...
    def calculate_roi_distillation_loss(self, images, soften_proposals, soften_results, cls_preprocess=None,
                                        cls_loss=None, bbs_loss=None, temperature=1):
