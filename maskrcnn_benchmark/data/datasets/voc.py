...
class PascalVOCDataset(torch.utils.data.Dataset):
        ...
        for w in range(len(total_classes)):
            ...
            for i in range(len(buff)):
                ...
                if b[1] == "-1":  # do not contain the category object
                    ...
                    if self.is_train and self.keep_difficult == False:
                        pass
                    else:
    ...
    def draw(self, index):
        ...
        anno = self.my_preprocess_annotation(anno)
    ...
    def __getitem__(self, index):
        ...
        return img, target, proposal, img_id, index
...
def main():
    data_dir = "/home/qijie/workspace/mma/MMA-main/data/voc07/VOCdevkit/VOC2007"
