...
_C.MODEL.FINETUNE_WEIGHT = ""  # no pre-trained model
...
_C.PSEUDO_LABELS.ENABLE = False

_C.PSEUDO_LABELS.TYPE = 'initial'

_C.PREVIOUS_LABELS_ENABLE = False

_C.PSEUDO_LABELS.SUPERVISION = False

# ---------------------------------------------------------------------------- #
# Clustering
# ---------------------------------------------------------------------------- #
# _C.CLUSTERING = CN()
# _C.CLUSTERING.ENABLE = False
# _C.CLUSTERING.MARGIN = 2.0
# _C.CLUSTERING.ITEMS_PER_CLASS = 100
# _C.CLUSTERING.START_ITER = 2000
# _C.CLUSTERING.UPDATE_MU_ITER = 500
# _C.CLUSTERING.MOMENTUM = 0.99
# _C.CLUSTERING.LOSS_WEIGHT = 0.2
# _C.CLUSTERING.MEAN_SAVE_PATH = 'clustering_mean'
# _C.CLUSTERING.BG_NUM = 5
# _C.CLUSTERING.UNK_NUM = 1
# _C.CLUSTERING.UNK_ENABLE = False
# _C.CLUSTERING.BG_ENABLE = False
